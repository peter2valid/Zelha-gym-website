<template>
  ...
  >
    ...
    <span class="font-bold text-sm hidden sm:inline">WhatsApp Us</span>
  </a>
</template>

<script setup lang="ts">
const message = encodeURIComponent("Hi! I found Zelha Spin and Fitness Gym through your website and I'd like to know more about joining.")
const whatsappUrl = `https://wa.me/254702836266?text=${message}`
</script>
